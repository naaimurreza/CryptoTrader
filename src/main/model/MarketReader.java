...
/*
 A market reader class for CryptoTrader
 */
public class MarketReader {
    private static HttpURLConnection connection;

    // EFFECTS: Makes a GET request to the API and returns a cryptocurrency
    ...
    // EFFECTS: Parses the JSON object returned from the GET request
